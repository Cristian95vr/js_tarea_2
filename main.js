...
class Carrito {
 ...
 eliminarProducto(sku, cantidad) {
    return new Promise((resolve, reject) => {
        ...
        const indiceProducto = this.productos.findIndex((producto) => producto.sku === sku);
        if (indiceProducto !== -1) {
            const productoExistente = this.productos[indiceProducto];
            ...
            reject(`Error, el producto ${sku} no esta en el carrito`);
        }
    });
}
}
